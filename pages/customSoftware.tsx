...
export default function CustomSoftware(props: any) {
  ...
  return (
    <Grid container direction="column">
      <Head>
        <title key="title">
          Custom Software Development And Design | Arc Development
        </title>
        <meta
          name="description"
          key="description"
        ...
        <meta
          property="og:title"
          key="og:title"
          content="Bringing West Coast Technology to te Midwest | Custom Software Development"
        />
        <meta
          property="og:url"
          key="og:url"
          content="https://nextjs-material-ui-arc.vercel.app/customSoftware"
        />
        <link
          rel="canonical"
          key="canonical"
